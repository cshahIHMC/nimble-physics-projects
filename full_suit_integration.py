...
# Insole Data functions #
def get_insole_acc_quat(insole_data):
...
def main():
    ...
    try:
        while True:
            ...
            # For the foot it is slightly different world - imu convention        
            foot_l_quat_joint_frame = foot_l_anatomical * foot_l_quat_zeroed * foot_l_anatomical.inv()
            foot_r_quat_joint_frame =  foot_r_anatomical * foot_r_quat_zeroed * foot_r_anatomical.inv()
